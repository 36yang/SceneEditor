...
namespace Ogre
{
	...
	public:
		...
		*/
		class GpuBufferAllocator : public TerrainAlloc
		{
		public:
			GpuBufferAllocator() {}
		...
		class DefaultGpuBufferAllocator : public GpuBufferAllocator
		{
		public:
		...
		*/
		...
		struct DerivedDataRequest
		{
			...
			Rect lightmapExtraDirtyRect;
			 friend std::ostream& operator<<(std::ostream& o, const DerivedDataRequest& r)
			{ return o; }		
		};
		...
		struct DerivedDataResponse
		{
			...
			PixelBox* lightMapBox;
			 friend std::ostream& operator<<(std::ostream& o, const DerivedDataResponse& r)
			{ return o; }		
		};
		...
		struct GenerateMaterialRequest
		{
			...
			bool synchronous;
			 friend std::ostream& operator<<(std::ostream& o, const GenerateMaterialRequest& r)
			{ return o; }		
		};
	...
	*/
	class  TerrainGlobalOptions : public TerrainAlloc, public Singleton<TerrainGlobalOptions>
	{
	protected:
